...
unsigned int uiADCOversampling(unsigned char );

unsigned int uiADCOversampling(unsigned char ucSamples){
...
static void adc_init(void)
{
	...
	ADC_REF_BANDGAP); //pod wskazan¹ konfiguracjê wpisujemy: wynik bez znaku, rozdzielczoœæ 12 bitów,  vref = 1V; rozdzielczosc moze byc jeszcze 8 bitowa lub 12 left-adjusted, LSB = Vref/ 2^res = 0.24mV
	...
	adcch_set_input(&adcch_conf, ADCCH_POS_PIN1, ADCCH_NEG_NONE, GAIN); //ostatnie to gain
